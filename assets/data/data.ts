...
export const data: ItemData[] = [
    {
        ...
        id:"p-fatrian",
        name:"Fatrian ERP",
        description:"Cloud-based ERP system for small and medium-sized businesses with multiple branches.",
    ...
    },
    {
        ...
        id:"p-iatutores",
        name:"IA Tutores",
        description:"Educational platform with courses for teachers to integrate AI tools into their methodology",
    ...
    },
    {
        ...
        description:"Web platform to manage sales and inventory for a costume shop for female entrepreneurs",
